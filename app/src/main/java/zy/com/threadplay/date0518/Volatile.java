 ...
 * 版    本：1.0
 * 创建日期：2018/5/18
 * 描    述：volatile是一种稍弱的同步机制，在访问volatile变量时不会执行加锁操作，也就不会执行线程阻塞，因此volatilei变量是一种比synchronized关键字更轻量级的同步机制。
 * 修订历史：https://blog.csdn.net/ns_code/article/details/17101369
 * ================================================
 */
